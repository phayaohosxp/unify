                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <a class="navbar-brand" href="index.html">
                                    <img id="logo-header" src="logo1-default.png" alt="Logo" width="80px">
                                </a>
                            </div>
                            <div class="col-md-10">
                                <a href="#"><img class="header-banner img-responsive" src="adds.jpg" width="100%" alt=""></a>
                            </div>
                        </div>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="page_home6.html">Option 14: Home Magazine</a></li>
                                    <li class="dropdown-submenu">
